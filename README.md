...
The application will be running at the following URL: <http://localhost:8080/erudio-jee-jsf-twiter-bootstrap-web>.
...
You should see messages similar to the following:
    ...
    INFO  [br.com.erudio.controller.MemberRegistration] (http--127.0.0.1-8080-2) Registering Jane Doe
    INFO  [br.com.erudio.test.MemberRegistrationTest] (http--127.0.0.1-8080-2) Jane Doe was persisted with id 1
    ...
    INFO  [org.jboss.as.connector.subsystems.datasources] (MSC service thread 1-5) JBAS010409: Unbound data source [jboss/datasources/erudio-jee-jsf-twiter-bootstrapTestDS]
